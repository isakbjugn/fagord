...
import { addVariant } from '~/src-without-remix/lib/fetch.client';
import { useDebounce } from '~/utils/use-debounce';
import { useOrdbokene } from '~/src-without-remix/utils/use-ordbokene.client';
import { Spinner } from '~/src-without-remix/components/spinner/spinner';
import { ToggleButton } from '~/src-without-remix/components/toggle-button/toggle-button';
                  ...
                  <Label>
                    ...
                    {suggestion && (
                      <div className={style['suggestion-feedback']}>
                        Mente du{' '}
                        <button onClick={() => setValue('term', suggestion)} style={{ cursor: 'pointer', border: 'none' }}>
                          {suggestion}
                        </button>
                        ?
                      </div>
