...
export const AboutPage = (): JSX.Element => (
  <main className={style.wrapper}>
    <article className={style.content}>
      ...
      <section>
        <p>
          Idéen om Fagord oppstod mens vi begge studerte nanoteknologi ved NTNU i Trondheim. Etter andreåret på studiet
          foregikk nærmest all undervisning på engelsk, og det ble stadig vanskeligere å ha faglige samtaler på norsk
          fordi vi rett og slett manglet ordene. Obskure ordbøker, premierte professorer og flittig fantasti kunne noen
          ganger gi oss nye ord, men disse var det vanskelig å systematisere og dele.
        </p>
      </section>
      <section>
        <p>
