        ...
        : <Form onSubmit={handleSubmit(onSubmit)}>
            {isWriting && (
              <Row>
                <Col>
                  <Label>
                    <input placeholder="Forslag" className="form-control" {...register("term", { required: true })} />
                  </Label>
                </Col>
                <Col>
                  <div className="btn-group" role="group" aria-label="Basic checkbox toggle button group">
                    <input value="nb" defaultChecked={true} type="radio" className="btn-check" id="btncheck1" autoComplete="off" {...register("dialect")} />
                    <label className="btn btn-outline-light" htmlFor="btncheck1">nb</label>

                    <input value="nn" type="radio" className="btn-check" id="btncheck2" autoComplete="off" {...register("dialect")} />
                    <label className="btn btn-outline-light" htmlFor="btncheck2">nn</label>
                  </div>
                </Col>
              </Row>
            )}
